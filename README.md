...
| PostgreSQL   | \* Резервное копирование<br/>\* Master-slave реплики<br/>\* Шардирование<br/>\* Асинхронная репликация<br/>\* pgBouncer |
...
| -------------- | ------------------ | ------------- | ------------- |
| **NGINX**      | L7-балансировка    | 10 000        | 20 МБ         |
...
| **Серверы Routing**         | 4xEPYC 9654/64x128GB/8xNVMe16T/8x100Gb/s            | 8      | $12 000/мес             |
| **Серверы Tile Render**     | 2xEPYC 9554/64x256GB/8xNVMe16T/4x100Gb/s            | 8      | $6 400/мес              |
...
| **Routing Service** | 32    | 40    | 6 Gb   | 8 Gb   | 10  | 11.75K RPS. Высокая нагрузка. 10 реплик для масштабирования и отказоустойчивости. |
| **Tile Render**     | 10    | 15    | 2 Gb   | 3 Gb   | 8   | 4.35K RPS. Ресурсоемкий рендеринг. 8 реплик для параллельной обработки.           |
