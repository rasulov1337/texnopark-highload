...
## Работа Mapnik с шардированными БД

Так как Mapnik не умеет из коробки работать с шардированными БД, напишем свое решение. Оно будет по координатам понимать, к какой БД идет обращение, собирать нужные данные и отдавать Mapnik.   
...
| PostgreSQL   | \* Резервное копирование<br/>\* Master-slave реплики<br/>\* Шардирование<br/>\* Асинхронная репликация<br/><br/>\* pgBouncer |
