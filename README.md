...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `node`, `node_tag`, `way`, `way_node`, `relation`, `relation_tag`, `relation_member`, `member_type` | (`34.8K`) Информация о местах + <br>(`33K`) Поиск мест + <br>(`17.4K`) Построение маршрутов +<br>(`34.8K` \* 25%) Отображение карты = `94K` | `100M` обновлений карты в день[^1][^16] / `86 400` (секунд в дне) = `1 157` QPS |
...
[^17] [How reviews on Google Maps work](https://blog.google/products/maps/how-google-maps-reviews-work/)
