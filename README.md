...
| ------------------------ | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | -------- | ------------------ |
| **Информация о местах**  | 0,003 МБ                                                                                            | 2,5 (действий в сутки) / 86400 (секунд в сутках) \* 300M DAU ≈ `8.7K` | **18K**  | **432 Мбит/с**     |
| **Поиск мест**           | 50 байт (название организации) \* 10 результатов = 0,5 КБ                                           | 2,37 / 86400 \* 300M ≈ `8.2K`                                         | **18K**  | **70 Мбит/с**      |
| **Построение маршрутов** | Возьмем маршрут в 10 км: возможно 200 точек \* 16 байт = 3,2 КБ + метаданные маршрута 2 КБ = 5,2 КБ | 1,25 / 86400 \* 300M  ≈ `4.3K`                                        | **10K**  | **406 Мбит/с**     |
