...
| **Поиск мест**           | 50 байт (название организации) \* 10 результатов = 0,5 КБ                                           | 2,37 / 86400 \* 600M ≈ `16.5K`                                         | **33K**   | **129 Мбит/с**     |
...
| **Отображение карты**    | при экране 1080p при масштабировании 16 уровня загружается 9-12 тайлов за раз. 12 \* 0,6 = 7,2 КБ   | 2,5 / 86400 \* 600M ≈ `17.4K`                                          | **34.8**  | **19 Гбит/с**      |
